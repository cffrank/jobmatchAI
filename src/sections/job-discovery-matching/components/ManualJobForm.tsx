...
interface ManualJobFormProps {
  onSubmit: (jobData: ManualJobData) => Promise<void>
  onCancel: () => void
}
...
export function ManualJobForm({ onSubmit, onCancel }: ManualJobFormProps) {
  ...
  return (
    <Card className="w-full max-w-3xl mx-auto">
      <CardHeader>
        ...
        <CardDescription>
          Create a new job entry to track or apply to
        </CardDescription>
      </CardHeader>
      <CardContent>
